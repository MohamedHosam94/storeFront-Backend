...
users.get('/', main_1.default, controller.index);
users.post('/', controller.create);
users.get('/:id', main_1.default, controller.show);
users.patch('/:id', main_1.default, controller.update);
users.delete('/:id', main_1.default, controller.destroy);
